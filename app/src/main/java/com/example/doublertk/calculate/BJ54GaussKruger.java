 ...
 */
public final class BJ54GaussKruger {

    // 椭球参数（Krassovsky）：a与1/f
    private static final double SEMI_MAJOR_AXIS = 6378245.0; // a 半长轴
    private static final double INVERSE_FLATTENING = 298.3;   // 1/f 反扁率
    ...
    public static final class Result {
        public final double northing; // x 北向（米）
        public final double easting;  // y 东向（米）
